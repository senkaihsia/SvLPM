...
class MainWindow(QMainWindow, svLumpedGui3A.Ui_MainWindow):
    ...
    def mousePressEvent(self, event):
        global ground, wireCount, groundActivated
    ...
    def exportXML(self):
        global wireCount, componentCount, groundActivated
        ...
        for QtGui.QGraphicsProxyWidget in allComponents[wireCount:totalComponents]:
            ...
            if groundActivated == True:
                if ComponentWidget == self.ground2:
