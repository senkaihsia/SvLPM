...
# Form implementation generated from reading ui file 'svLumpedGui2C.ui'
#
# Created: Mon Jul 24 09:34:41 2017
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.DrawLine = QtGui.QPushButton(self.centralwidget)
        self.DrawLine.setGeometry(QtCore.QRect(0, 300, 101, 41))
        self.DrawLine.setIconSize(QtCore.QSize(45, 60))
        self.DrawLine.setObjectName(_fromUtf8("DrawLine"))
        self.graphicsView = CircuitView(self.centralwidget)
        self.graphicsView.setGeometry(QtCore.QRect(100, 10, 751, 381))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.DrawLine.setToolTip(QtGui.QApplication.translate("MainWindow", "Create Wire", None, QtGui.QApplication.UnicodeUTF8))
        self.DrawLine.setStatusTip(QtGui.QApplication.translate("MainWindow", "Click to Create Wire", None, QtGui.QApplication.UnicodeUTF8))
        self.DrawLine.setText(QtGui.QApplication.translate("MainWindow", "Create Wire", None, QtGui.QApplication.UnicodeUTF8))
